...
void Buffer::copy(vk::CommandPool command_pool, Buffer& dst_buffer, vk::DeviceSize size)
{
    vk::CommandBuffer command_buffer =
        _device.create_and_begin_command_buffer(command_pool);
...
void Buffer::copy(vk::CommandPool command_pool, Buffer& dst_buffer)
{
    copy(command_pool, dst_buffer, dst_buffer.size());
}

void Buffer::copy_to_texture(
...
void Buffer::copy_to_texture(
    vk::CommandPool command_pool, Texture& dst_texture, int layer)
{
    copy_to_texture(
        command_pool, dst_texture, layer, vk::Offset3D(0, 0, 0), dst_texture.extent());
}
